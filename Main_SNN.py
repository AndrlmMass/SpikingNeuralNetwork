...
snn = SNN_STDP(V_th=0.7, V_reset=-0.1, C=10, R=5, A_minus=-0.001, tau_m=0.1, num_items=10, 
                 tau_stdp=0.01, A_plus=0.001, dt=0.001, T=0.1, V_rest=0.1, num_neurons=20,
                 excit_inhib_ratio = 0.8, alpha=1, num_input_neurons=4, 
                 max_weight=1, min_weight=-1, input_scaler=2)
...
# Visualize training
snn.plot_training(num_neurons=20, num_items=10, num_weights=10)
