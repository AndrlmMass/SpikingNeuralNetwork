...
snn = SNN_STDP(V_th=0.7, V_reset=-0.7, R=5, A_minus_in=-0.08, tau_m=0.7, num_items=100, 
                 tau_stdp=50, A_plus_in=0.007, A_plus_ex=0.004, A_minus_ex =-0.0035, 
                 dt=0.001, T=0.1, V_rest=0.1, num_neurons=10, init_cals = 700,
                 excit_inhib_ratio = 0.8, alpha=1, num_input_neurons=10, 
                 max_weight=1, min_weight=-1, input_scaler=1, ex_interval=0.3, in_interval=0.2)
...
# Visualize training
snn.plot_training(num_neurons=10, num_items=10, num_weights=20)
