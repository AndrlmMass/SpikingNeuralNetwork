...
snn = SNN_STDP(V_th=-55, V_reset=-75, C=10, R=1, A_minus=-0.1, tau_m=0.02, num_items=100, 
                 ...
                 interval=0.03, max_weight=1, min_weight=-1, input_scaler=1000)
...
snn.visualize_combined(10, 5)
#snn.visualize_membrane_potentials(num_items_to_plot=10, num_neurons_to_plot=5)
