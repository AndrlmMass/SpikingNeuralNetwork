...
snn_params = {
    "V_th": -50,  # Spiking threshold
    "V_reset": -70,  # Reset potential following spike
...
snn.gen_data(
    ...
    var_high_freq=0.05,
    var_low_freq=0.05,
)  # Need to add on/off period here -> based on article

# Visualize data
snn.visualize_data(single_data=False, raster_plot_=True, alt_raster_plot=False)
