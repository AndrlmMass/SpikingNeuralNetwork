    ...
    def load_data(self, parameters, base_dir="data/sdata"):
        ...
        for folder in os.listdir(base_dir):
            ...
            if stored == parameters:
                ...
                return {
                    "data_train": np.load(
                        os.path.join(base_dir, folder, "data_train.npy")
                    ),
                    "labels_train": np.load(
                        os.path.join(base_dir, folder, "labels_train.npy")
                    ),
                    "data_test": np.load(
                        os.path.join(base_dir, folder, "data_test.npy")
                    ),
                    "labels_test": np.load(
                        os.path.join(base_dir, folder, "labels_test.npy")
                    ),
                }
        return None
