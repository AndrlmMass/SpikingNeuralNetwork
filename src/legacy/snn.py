...
class snn_sleepy:
    ...
    def prepare_data(
        ...
        self.geom_noise_mean = geom_noise_mean
        ...
        self.data_loaded = False # should it be false?
        self.model_loaded = False # should it be false?
        self.test_data_loaded = False # should it be false?
        self.loaded_phi_model = False # should it be false?
        ...
        if self.image_dataset != "geomfig":
            # Initiate batch and number of tests/trains
