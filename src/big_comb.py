    ...
    def train_network(
        ...
        if not self.model_loaded:
            ...
            for e in range(self.epochs):
                ...
                acc_str = f"{acc_LR:.3f}" if acc_LR is not None else "N/A"
        ...
        max_test_samples = self.all_images_test * self.num_steps
        test_sample_count = 0
        acc_top_sum = 0.0
        acc_LR_sum = 0.0
        phi_sum = 0.0
