...
\begin{tabular}{lrrrr}
\toprule
& MNIST & Fashion & KMNIST & notMNIST \\
\midrule
\multicolumn{5}{l}{\emph{against frozen weights, oriented prior}} \\
trace-STDP & $-2.19^{***}$ & $-0.38$ & $-4.28^{***}$ & $-2.78^{***}$ \\
triplet-STDP & $-1.86^{***}$ & $-1.60^{***}$ & $-1.19^{***}$ & $-0.41$ \\
+ iSTDP (Vogels) & $-2.18^{***}$ & $-1.40^{***}$ & $-5.39^{***}$ & $-4.04^{***}$ \\
no E$\to$E recurrence & $-1.52^{***}$ & $-0.47$ & $-3.61^{***}$ & $-2.88^{***}$ \\
no I$\to$E inhibition & $-4.09^{***}$ & $-0.91^{**}$ & $-5.54^{***}$ & $-3.31^{***}$ \\
\midrule
\multicolumn{5}{l}{\emph{against random connectivity, trace-STDP}} \\
oriented receptive fields & $+0.64^{***}$ & $+3.12^{***}$ & $+3.48^{***}$ & $+3.24^{***}$ \\
\bottomrule
\end{tabular}
